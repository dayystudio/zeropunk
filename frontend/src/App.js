...
const App = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'broadcast', 'about', 'beta', 'support', 'visual-archive', 'faq', 'alia', 'character', 'pc_requirements', 'stats', 'live_activity', 'zeromarket', 'reality-fractures', 'youngshop', 'roadmap', 'modding', 'contact'];
  ...
  const menuItems = [
    ...
    { id: 'youngshop', label: t('youngshop_title'), icon: <ShoppingBag size={16} /> },
